                ...
                <table class="footer_table">
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <div class="cont_notation"><span class="skin bold">ΠΑΡΑΤΗΡΗΣΕΙΣ:</span>
                                ...
                                <div class="cont_signs">
                                    <div class="cont_sign_left">
                                        <span class="sign_left">ΕΚΔΟΣΗ</span>
                                        <br>
                                        <br>
                                        <br>
                                        <br>
                                        <hr class="sign_hr">
                                        <span class="fullname_sign">Ονοματεπώνυμο Υπογραφή</span>
                                    </div>
                                    <div class="cont_sign_right">
                                        <span class="sign_right">ΠΑΡΑΛΑΒΗ</span>
                                        <br>
                                        <br>
                                        <br>
                                        <br>
                            ...
                            <td>
                                <div class="count_totals_container">
                                    <span>ΣΥΝΟΛΟ ΤΕΜΑΧΙΩΝ: </span> <span class="count_total_prods"></span>
                                </div>
