...
class PrimerReceiptLogListAutomation {
	...
	public function get() {
		...
		if ($receipt_log_query->have_posts()):
			while ($receipt_log_query->have_posts()):
				...
				$this->receipt_log_array[$receipt_log_count]['receipt_log_automation_order_id'] = get_post_meta(get_the_ID(), 'receipt_log_automation_order_id', true);
				$this->receipt_log_array[$receipt_log_count]['receipt_log_automation_order_date'] = get_post_meta(get_the_ID(), 'receipt_log_automation_order_date', true);
				$this->receipt_log_array[$receipt_log_count]['receipt_log_automation_invoice_id'] = $invoice_log_id;
				$this->receipt_log_array[$receipt_log_count]['receipt_log_automation_invoice_date'] = $invoice_log_date;
				$this->receipt_log_array[$receipt_log_count]['receipt_log_automation_client'] = $invoice_log_client;
				$this->receipt_log_array[$receipt_log_count]['receipt_log_automation_status'] = $receipt_log_status_text;
				$this->receipt_log_array[$receipt_log_count]['receipt_log_automation_email'] = $receipt_log_email_status_text;
				$this->receipt_log_array[$receipt_log_count]['receipt_log_automation_error'] = $receipt_log_error;
				$this->receipt_log_array[$receipt_log_count]['receipt_log_automation_email_error'] = $receipt_log_email_error;
				$receipt_log_count++;
			endwhile;
		endif;
		wp_reset_postdata();
	...
	public function get_with_params($receipt_log_error, $receipt_log_issue) {
		...
		if ($receipt_log_query->have_posts()):
			while ($receipt_log_query->have_posts()):
				...
				$this->receipt_log_params_array[$receipt_count]['receipt_log_automation_order_id'] = get_post_meta(get_the_ID(), 'receipt_log_automation_order_id', true);
				$this->receipt_log_params_array[$receipt_count]['receipt_log_automation_order_date'] = get_post_meta(get_the_ID(), 'receipt_log_automation_order_date', true);

				$this->receipt_log_params_array[$receipt_count]['receipt_log_automation_invoice_id'] = $invoice_log_id;
				$this->receipt_log_params_array[$receipt_count]['receipt_log_automation_invoice_date'] = $invoice_log_date;

				$this->receipt_log_params_array[$receipt_count]['receipt_log_automation_client'] = $invoice_log_client;
				$this->receipt_log_params_array[$receipt_count]['receipt_log_automation_status'] = $receipt_log_status_text;
				$this->receipt_log_params_array[$receipt_count]['receipt_log_automation_email'] = $receipt_log_email_status_text;
				$this->receipt_log_params_array[$receipt_count]['receipt_log_automation_error'] = '';
				$this->receipt_log_params_array[$receipt_count]['receipt_log_automation_email_error'] = $receipt_log_email_error;
				$receipt_count++;
			endwhile;
		endif;
		wp_reset_postdata();
